									...
									for($a=0;$a<count($tlist);$a++){
										if($current_number['tema']==$tlist[$a]){
											if(in_array($tlist[$a], $tema1)){
												$points8 = $start8[1]*C('幸运飞艇_tema_sz_1');
											}
											if(in_array($tlist[$a], $tema2)){
												$points8 = $start8[1]*C('幸运飞艇_tema_sz_2');
											}
											if(in_array($tlist[$a], $tema3)){
												$points8 = $start8[1]*C('幸运飞艇_tema_sz_3');
											}
											if(in_array($tlist[$a], $tema4)){
												$points8 = $start8[1]*C('幸运飞艇_tema_sz_4');
											}
											if(in_array($tlist[$a], $tema5)){
												$points8 = $start8[1]*C('幸运飞艇_tema_sz_5');
											}
											$num8 = 1;
										}
									}
				...
				if($list){
					for($i=0;$i<count($list);$i++){
						...
						case 7:
							...
							if($num71>0 && $num72>0){
								$points7 = $num71*$num72*$start7[2]*C('幸运飞艇_he');
